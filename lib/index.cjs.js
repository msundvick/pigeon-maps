...
var Map = /*#__PURE__*/function (_Component) {
  function Map(props) {
    ...
    _defineProperty(_this, "_containerRef", void 0);
    _defineProperty(_this, "_mousePosition", void 0);
    _defineProperty(_this, "_loadTracker", void 0);
    _defineProperty(_this, "_dragStart", null);
    _defineProperty(_this, "_mouseDown", false);
    _defineProperty(_this, "_moveEvents", []);
    _defineProperty(_this, "_lastClick", null);
    _defineProperty(_this, "_lastTap", null);
    _defineProperty(_this, "_lastWheel", null);
    _defineProperty(_this, "_touchStartPixel", null);
    _defineProperty(_this, "_touchStartMidPoint", null);
    _defineProperty(_this, "_touchStartDistance", null);
    _defineProperty(_this, "_secondTouchEnd", null);
    _defineProperty(_this, "_warningClearTimeout", null);
    _defineProperty(_this, "_isAnimating", false);
    _defineProperty(_this, "_animationStart", null);
    _defineProperty(_this, "_animationEnd", null);
    _defineProperty(_this, "_zoomStart", null);
    _defineProperty(_this, "_centerTarget", null);
    _defineProperty(_this, "_zoomTarget", null);
    _defineProperty(_this, "_zoomAround", null);
    _defineProperty(_this, "_animFrame", null);
    _defineProperty(_this, "_boundsSynced", false);
    _defineProperty(_this, "_minMaxCache", null);
    _defineProperty(_this, "_lastZoom", void 0);
    _defineProperty(_this, "_lastCenter", void 0);
    _defineProperty(_this, "_centerStart", void 0);
    _defineProperty(_this, "_resizeObserver", null);
    _defineProperty(_this, "updateWidthHeight", function () {
    ...
    _defineProperty(_this, "unbindWheelEvent", function () {
      if (_this._containerRef) {
        _this._containerRef.removeEventListener('wheel', _this.handleWheel);
      }
    });
    _defineProperty(_this, "setCenterZoomTarget", function (center, zoom, fromProps, zoomAround, animationDuration) {
      if (fromProps === void 0) {
        fromProps = false;
      }
      ...
      if (_this.props.animate && (!fromProps || _this.props.animateMaxScreens && _this.distanceInScreens(center, zoom, _this.state.center, _this.state.zoom) <= _this.props.animateMaxScreens)) {
    ...
    _defineProperty(_this, "setCenterZoomForChildren", function (center, zoom) {
      _this.setCenterZoomTarget(center || _this.state.center, zoom || _this.state.zoom, true);
    });
    _defineProperty(_this, "distanceInScreens", function (centerTarget, zoomTarget, center, zoom) {
    ...
    _defineProperty(_this, "animationStep", function (timestamp) {
    ...
    _defineProperty(_this, "animate", function (timestamp) {
    ...
    _defineProperty(_this, "stopAnimating", function () {
      if (_this._isAnimating) {
        _this._isAnimating = false;
        _this.onAnimationStop();
        cancelAnimationFrame(_this._animFrame);
    ...
    _defineProperty(_this, "limitCenterAtZoom", function (center, zoom) {
    ...
    _defineProperty(_this, "onAnimationStart", function () {
      _this.props.onAnimationStart && _this.props.onAnimationStart();
    });
    _defineProperty(_this, "onAnimationStop", function () {
      _this.props.onAnimationStop && _this.props.onAnimationStop();
    });
    _defineProperty(_this, "setCenterZoom", function (center, zoom, animationEnded) {
    ...
    _defineProperty(_this, "getBoundsMinMax", function (zoom) {
    ...
    _defineProperty(_this, "tileLoaded", function (key) {
        ...
        if (_this.coordsInside(pixel)) {
          ...
          if (!_this.props.twoFingerDrag) {
            ...
            if (_this._lastTap && performanceNow() - _this._lastTap < DOUBLE_CLICK_DELAY) {
              ...
              _this.setCenterZoomTarget(null, Math.max(_this.props.minZoom || 0, Math.min(_this.state.zoom + 1, _this.props.maxZoom || 0)), false, latLngNow);
            } else {
    ...
    _defineProperty(_this, "handleTouchMove", function (event) {
      ...
      if (event.touches.length === 1 && _this._touchStartPixel) {
        ...
        var zoomDelta = Math.max(_this.props.minZoom || 0, Math.min(_this.props.maxZoom || 0, zoom + Math.log2(distance / _this._touchStartDistance))) - zoom;
      ...
      if (_this._touchStartPixel) {
        ...
        if (event.touches.length === 0) {
          ...
          if (zoomSnap) {
            ...
            var _zoom = Math.max(minZoom || 0, Math.min(zoomTarget, maxZoom || 0));
    ...
    _defineProperty(_this, "handleMouseUp", function (event) {
      if (!_this._containerRef) {
    ...
    _defineProperty(_this, "stopTrackingMoveEvents", function () {
      _this._moveEvents = [];
    });
    _defineProperty(_this, "trackMoveEvents", function (coords) {
    ...
    _defineProperty(_this, "throwAfterMoving", function (coords, center, zoom) {
    ...
    _defineProperty(_this, "sendDeltaChange", function () {
    ...
    _defineProperty(_this, "getBounds", function (center, zoom) {
      if (center === void 0) {
    ...
    _defineProperty(_this, "syncToProps", function (center, zoom) {
      if (center === void 0) {
        center = _this.state.center;
      }
      if (zoom === void 0) {
    ...
    _defineProperty(_this, "handleWheel", function (event) {
    ...
    _defineProperty(_this, "showWarning", function (warningType) {
    ...
    _defineProperty(_this, "clearWarning", function () {
    ...
    _defineProperty(_this, "zoomAroundMouse", function (zoomDiff, event) {
      if (!_this._containerRef) {
        return;
      }
    ...
    _defineProperty(_this, "zoomPlusDelta", function () {
      return _this.state.zoom + _this.state.zoomDelta;
    });
    _defineProperty(_this, "pixelToLatLng", function (pixel, center, zoom) {
      if (center === void 0) {
        center = _this.state.center;
      }
      if (zoom === void 0) {
    ...
    _defineProperty(_this, "latLngToPixel", function (latLng, center, zoom) {
      if (center === void 0) {
        center = _this.state.center;
      }
      if (zoom === void 0) {
      ...
      var tileX = lng2tile((latLng === null || latLng === void 0 ? void 0 : latLng[1]) || 0, zoom);
      var tileY = lat2tile((latLng === null || latLng === void 0 ? void 0 : latLng[0]) || 0, zoom);
    ...
    _defineProperty(_this, "calculateZoomCenter", function (center, coords, oldZoom, newZoom) {
    ...
    _defineProperty(_this, "setRef", function (dom) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    this.bindWheelEvent();
    this.syncToProps();
    if (typeof ((_window3 = window) === null || _window3 === void 0 ? void 0 : _window3.ResizeObserver) !== 'undefined') {
      var _this$_resizeObserver;
      this._resizeObserver = new window.ResizeObserver(function () {
        _this2.updateWidthHeight();
      });
      this._containerRef && ((_this$_resizeObserver = this._resizeObserver) === null || _this$_resizeObserver === void 0 ? void 0 : _this$_resizeObserver.observe(this._containerRef));
    }
  };
  ...
  _proto.coordsInside = function coordsInside(pixel) {
    var _this$state0 = this.state,
      width = _this$state0.width,
      height = _this$state0.height;
  ...
  _proto.renderTiles = function renderTiles() {
    ...
    var _this$state1 = this.state,
      oldTiles = _this$state1.oldTiles,
      width = _this$state1.width,
      height = _this$state1.height;
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      return Tile ? /*#__PURE__*/React__default["default"].createElement(Tile, {
        key: tile.key,
        tile: tile,
  ...
  _proto.renderWarning = function renderWarning() {
    ...
    var _this$state11 = this.state,
      showWarning = _this$state11.showWarning,
      warningType = _this$state11.warningType,
    ...
    if (metaWheelZoom && metaWheelZoomWarning || twoFingerDrag && twoFingerDragWarning) {
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        style: style
      }, warningText === null || warningText === void 0 ? void 0 : warningText.replace('META', meta));
    } else {
      return null;
    }
  };
...
function Marker(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    onClick: props.onClick ? function (event) {
      var _props$onClick;
      return (_props$onClick = props.onClick) === null || _props$onClick === void 0 ? void 0 : _props$onClick.call(props, eventParameters(event));
    } : undefined,
    onContextMenu: props.onContextMenu ? function (event) {
      var _props$onContextMenu;
      return (_props$onContextMenu = props.onContextMenu) === null || _props$onContextMenu === void 0 ? void 0 : _props$onContextMenu.call(props, eventParameters(event));
    } : undefined,
...
function PointComponent(props) {
  ...
  if (latLngToPixel) {
    ...
    if ((_props$svgAttributes = props.svgAttributes) !== null && _props$svgAttributes !== void 0 && _props$svgAttributes.path) {
      var path = "M" + cx + "," + cy + "c" + props.svgAttributes.path.split(/[c|C|L|l|v|V|h|H]([^]*)/)[1];
...
function MultiPoint(props) {
  var _props$coordinates2;
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, (_props$coordinates2 = props.coordinates) === null || _props$coordinates2 === void 0 ? void 0 : _props$coordinates2.map(function (point, i) {
...
function LineString(props) {
  ...
  var p = 'M' + props.coordinates.reduce(function (a, _ref) {
    var y = _ref[0],
      x = _ref[1];
    var _ref2 = (latLngToPixel === null || latLngToPixel === void 0 ? void 0 : latLngToPixel([x, y])) || [0, 0],
      v = _ref2[0],
      w = _ref2[1];
    return a + ' ' + v + ' ' + w;
  }, '');
...
function MultiLineString(props) {
  var _props$coordinates3;
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, (_props$coordinates3 = props.coordinates) === null || _props$coordinates3 === void 0 ? void 0 : _props$coordinates3.map(function (line, i) {
...
function Polygon(props) {
  ...
  var p = props.coordinates.reduce(function (a, part) {
    return a + ' M' + part.reduce(function (a, _ref3) {
      var y = _ref3[0],
        x = _ref3[1];
      var _ref4 = (latLngToPixel === null || latLngToPixel === void 0 ? void 0 : latLngToPixel([x, y])) || [0, 0],
        v = _ref4[0],
        w = _ref4[1];
      return a + ' ' + v + ' ' + w;
    }, '') + 'Z';
...
function MultiPolygon(props) {
  var _props$coordinates4;
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, (_props$coordinates4 = props.coordinates) === null || _props$coordinates4 === void 0 ? void 0 : _props$coordinates4.map(function (polygon, i) {
...
function GeometryCollection(props) {
  ...
  var _ref5 = props.geometry || {},
    type = _ref5.type,
    coordinates = _ref5.coordinates,
    geometries = _ref5.geometries;
  if (type === 'GeometryCollection') {
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, geometries === null || geometries === void 0 ? void 0 : geometries.map(function (geometry, i) {
...
function Draggable(props) {
  ...
  var _ref = props.mapProps || {},
    mouseEvents = _ref.mouseEvents,
    touchEvents = _ref.touchEvents;
  React.useEffect(function () {
    var handleDragStart = function handleDragStart(event) {
      if (isDescendentOf(event.target, dragRef.current)) {
        ...
        if (propsRef.current.onDragStart) {
          var _propsRef$current$onD, _propsRef$current2;
          ...
          (_propsRef$current$onD = (_propsRef$current2 = propsRef.current).onDragMove) === null || _propsRef$current$onD === void 0 ? void 0 : _propsRef$current$onD.call(_propsRef$current2, pixelToLatLng === null || pixelToLatLng === void 0 ? void 0 : pixelToLatLng([(_left || 0) + (offset ? offset[0] : 0), (_top || 0) + (offset ? offset[1] : 0)]));
        }
      }
    };
    var handleDragMove = function handleDragMove(event) {
      ...
      var deltaX = x - (stateRef.current.startX || 0);
      var deltaY = y - (stateRef.current.startY || 0);
      setState({
        deltaX: deltaX,
        deltaY: deltaY
      });
      if (propsRef.current.onDragMove) {
        ...
        propsRef.current.onDragMove(pixelToLatLng === null || pixelToLatLng === void 0 ? void 0 : pixelToLatLng([(_startLeft || 0) + deltaX + (offset ? offset[0] : 0), (_startTop || 0) + deltaY + (offset ? offset[1] : 0)]));
      }
    };
    var handleDragEnd = function handleDragEnd(event) {
      var _propsRef$current$onD2, _propsRef$current5;
      if (!stateRef.current.isDragging) {
        return;
      }
      event.preventDefault();
      var _propsRef$current4 = propsRef.current,
        offset = _propsRef$current4.offset,
        pixelToLatLng = _propsRef$current4.pixelToLatLng;
      ...
      (_propsRef$current$onD2 = (_propsRef$current5 = propsRef.current).onDragEnd) === null || _propsRef$current$onD2 === void 0 ? void 0 : _propsRef$current$onD2.call(_propsRef$current5, pixelToLatLng === null || pixelToLatLng === void 0 ? void 0 : pixelToLatLng([(startLeft || 0) + deltaX + (offset ? offset[0] : 0), (startTop || 0) + deltaY + (offset ? offset[1] : 0)]));
      setState({
        isDragging: false,
        startX: undefined,
        startY: undefined,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    style: _objectSpread2(_objectSpread2({
      ...
      position: 'absolute',
      transform: "translate(" + (isDragging ? (startLeft || 0) + deltaX : left) + "px, " + (isDragging ? (startTop || 0) + deltaY : top) + "px)"
    }),
    ref: dragRef,
...
function ZoomControl(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    onClick: function onClick() {
      return setCenterZoom === null || setCenterZoom === void 0 ? void 0 : setCenterZoom(mapState === null || mapState === void 0 ? void 0 : mapState.center, Math.min(((mapState === null || mapState === void 0 ? void 0 : mapState.zoom) || 0) + 1, (mapProps === null || mapProps === void 0 ? void 0 : mapProps.maxZoom) || 0));
    }
  }, "+"), /*#__PURE__*/React__default["default"].createElement("button", {
    ...
    style: buttonStyle ? _objectSpread2(_objectSpread2({}, commonButtonStyle), buttonStyle) : commonButtonStyle,
    onClick: function onClick() {
      return setCenterZoom === null || setCenterZoom === void 0 ? void 0 : setCenterZoom(mapState === null || mapState === void 0 ? void 0 : mapState.center, Math.max(((mapState === null || mapState === void 0 ? void 0 : mapState.zoom) || 0) - 1, (mapProps === null || mapProps === void 0 ? void 0 : mapProps.minZoom) || 0));
    }
  }, "\u2013"));
}
